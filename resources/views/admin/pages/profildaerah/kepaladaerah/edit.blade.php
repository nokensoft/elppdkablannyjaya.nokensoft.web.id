                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form action="{{route('admin.profildaerah.kepaladaerah.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')

                                    <div class="mb-3 fs-4">
                                        <label for="kepala_nama" class="fw-bold">Nama Kepala Daerah</label>
                                        <input type="text" class="form-control form-control-lg" id="kepala_nama" name="kepala_nama" value="{{old('kepala_nama') ? old('kepala_nama') : $data->kepala_nama }}">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="kepala_tgl_pelantikan" name="kepala_tgl_pelantikan" value="{{old('kepala_tgl_pelantikan') ? old('kepala_tgl_pelantikan') : $data->kepala_tgl_pelantikan }}">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="kepala_no_sk" name="kepala_no_sk" value="{{old('kepala_no_sk') ? old('kepala_no_sk') : $data->kepala_no_sk }}">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="kepala_file_sk" name="kepala_file_sk" value="{{old('kepala_file_sk') ? old('kepala_file_sk') : $data->kepala_file_sk }}">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        @else
                                            <img src="{{ url($data->kepala_foto)}}" alt="{{$data->kepala_foto}}" class="img-fluid img-thumbnail"  width="250px" class="img-thumbnail"></td>
                                        @endif
