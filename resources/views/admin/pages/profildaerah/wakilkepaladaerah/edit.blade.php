                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                        ...
                        <form action="{{route('admin.profildaerah.wakilkepaladaerah.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_nama" class="fw-bold d-block mb-2">Nama Wakil Kepala Daerah</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_nik" class="fw-bold d-block mb-2">NIK</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_tgl_lahir" class="fw-bold d-block mb-2">Tanggal Lahir</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_tgl_pelantikan" class="fw-bold d-block mb-2">Tanggal Pelantikan</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_no_sk" class="fw-bold d-block mb-2">Nomor SK</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_file_sk" class="fw-bold d-block mb-2">File SK</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_asal_partai" class="fw-bold d-block mb-2">Asal Partai</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_visi_misi" class="fw-bold d-block mb-2">Visi & Misi</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_riwayat" class="fw-bold d-block mb-2">Riwayat Hidup</label>
                            ...
                            <div class="mb-3 fs-4">
                                <label for="wakil_foto" class="fw-bold d-block mb-2">Foto Wakil Kepala Daerah</label>
                                @if ($data->wakil_foto == null)
                                <img src="{{ asset('gambar/default.png') }}" alt="gambar" width="250px" class="img-thumbnail">
                                @else
                                <img src="{{ asset('gambar/' .$data->wakil_foto)}}" alt="gambar" class="img-fluid img-thumbnail" width="250px" class="img-thumbnail"></td>
                                @endif

                                <input type="text" class="form-control form-control-lg mt-2" id="wakil_foto" name="wakil_foto" value="{{old('wakil_foto') ? old('wakil_foto') : $data->wakil_foto }}">
