        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">Wakil Kepala Daerah</li>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                        ...
                        <form action="{{route('admin.profildaerah.wakilkepaladaerah.update',$data->id)}}" method="POST"
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_nama"
                                    name="wakil_nama"
                                    value="{{old('wakil_nama') ? old('wakil_nama') : $data->wakil_nama }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_nik" name="wakil_nik"
                                    value="{{old('wakil_nik') ? old('wakil_nik') : $data->wakil_nik }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_tgl_lahir"
                                    name="wakil_tgl_lahir"
                                    value="{{old('wakil_tgl_lahir') ? old('wakil_tgl_lahir') : $data->wakil_tgl_lahir }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_tgl_pelantikan"
                                    name="wakil_tgl_pelantikan"
                                    value="{{old('wakil_tgl_pelantikan') ? old('wakil_tgl_pelantikan') : $data->wakil_tgl_pelantikan }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_no_sk"
                                    name="wakil_no_sk"
                                    value="{{old('wakil_no_sk') ? old('wakil_no_sk') : $data->wakil_no_sk }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_file_sk"
                                    name="wakil_file_sk"
                                    value="{{old('wakil_file_sk') ? old('wakil_file_sk') : $data->wakil_file_sk }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="wakil_asal_partai"
                                    name="wakil_asal_partai"
                                    value="{{old('wakil_asal_partai') ? old('wakil_asal_partai') : $data->wakil_asal_partai }}">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <textarea name="wakil_visi_misi" id="wakil_visi_misi" cols="30" rows="10"
                                    class="form-control form-control-lg">{{old('wakil_visi_misi') ? old('wakil_visi_misi') : $data->wakil_visi_misi }}</textarea>
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <textarea name="wakil_riwayat" id="wakil_riwayat" cols="30" rows="10"
                                    class="form-control form-control-lg">{{old('wakil_riwayat') ? old('wakil_riwayat') : $data->wakil_riwayat }}</textarea>
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                @else
                                <img src="{{ url($data->wakil_foto)}}" alt="{{$data->wakil_foto}}"
