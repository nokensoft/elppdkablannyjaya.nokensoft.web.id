                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form action="{{route('admin.profildaerah.sekretarisdaerah.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3 fs-4">
                                        @if ($data->sekretaris_foto == null)
                                            <img src="{{asset('assets/images/profildaerah/sekretaris.png')}}" alt="{{$data->slug}}"  width="250px" class="img-thumbnail">
                                        @else
                                            <img src="{{ url($data->sekretaris_foto)}}" alt="{{$data->sekretaris_foto}}" class="img-fluid img-thumbnail"  width="250px" class="img-thumbnail"></td>
                                        @endif
