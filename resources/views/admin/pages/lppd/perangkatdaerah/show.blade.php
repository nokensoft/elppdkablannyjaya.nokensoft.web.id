            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                        ...
                        <h3 class="text-center fw-bold">Detail Data {{ $data->perangkatdaerah->nama_organisasi ?? '' }}
                        </h3>
                        <br>
                        <form>
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" readonly
                                    value="{{ $data->perangkatdaerah->tipe_kantor ?? '' }}">
                            </div>
                            <div class="mb-3 fs-4">
                                <label for="" class="fw-bold">Alamat</label>
                                <textarea ows="5" class="form-control form-control-lg"
                                    readonly>{{ $data->perangkatdaerah->alamat ?? ''}}</textarea>
                            </div>

                            <div class="mb-2 fs-4">
                                <label for="" class="fw-bold">Nama Pimpinan</label>
                                <input type="text" class="form-control form-control-lg" readonly
                                    value="{{ $data->perangkatdaerah->nama_pimpinan ?? '' }}">
                            </div>
                            <div class="mb-2 fs-4">
                                <label for="" class="fw-bold">Jumlah Pegawai</label>
                                <input type="text" class="form-control form-control-lg" readonly
                                    value="{{ $data->perangkatdaerah->jumlah_pegawai ?? '' }}">
                            </div>
                            ...
                            <div class="border-top border-1 pt-3 mt-4">
                                <a href="{{route('admin.perangkatdaerah.edit',$data->id)}}"
                                    class="btn btn-outline-warning waves-effect waves-light fs-4">
