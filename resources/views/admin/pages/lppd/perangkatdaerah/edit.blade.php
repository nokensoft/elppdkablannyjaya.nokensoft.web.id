            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                        ...
                        <br>
                        <form action="{{route('admin.perangkatdaerah.update',$data->id)}}" method="POST"
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    ...
                                    value="{{ old('nama_organisasi',$data->perangkatdaerah->nama_organisasi ?? '')}}"
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Tipe kantor"
                                    value="{{ old('tipe_kantor',$data->perangkatdaerah->tipe_kantor ?? '')}}"
                                    name="tipe_kantor">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <textarea name="alamat" id="" rows="5" class="form-control form-control-lg"
                                    placeholder="Alamat Kantor">{{ old('alamat',$data->perangkatdaerah->alamat ?? '')}}</textarea>
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    placeholder="Nama Pimpinan Dinas"
                                    value="{{ old('nama_pimpinan',$data->perangkatdaerah->nama_pimpinan ?? '')}}"
                                    name="nama_pimpinan">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Jumlah Pegawai"
                                    value="{{ old('jumlah_pegawai',$data->perangkatdaerah->jumlah_pegawai ?? '')}}"
                                    name="jumlah_pegawai">
