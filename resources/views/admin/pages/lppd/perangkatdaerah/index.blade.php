                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <a href="{{ route('admin.perangkatdaerah.pdf') }}" target="_blank"
                                        ...
                                        <tr>
                                            <td>
                                                @if (empty($data->perangkatdaerah->foto_gedung))
                                                    <img src="{{ asset('gambar/default.png') }}" alt="Foto Kantor"
                                                        width="150px" class="img-thumbnail">
                                                @else
                                                    <img src="{{ asset('gambar/' . $data->perangkatdaerah->foto_gedung) }}"
