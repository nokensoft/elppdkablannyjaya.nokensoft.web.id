        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{asset('admin/lppd/pelaporan')}}"
                    ...
                    <a href="{{asset('admin/lppd/pelaporan/2021')}}" class="btn btn-info waves-effect waves-light fs-4">
                            ...
                            <tbody>
                                ...
                                <tr class="@if ($data->cover != '') bg-success text-light @endif">
                                    ...
                                    <td class="text-center">
                                        @if ($data->cover != '') <i class="fas fa-check mr-1"></i> @else <i
                                            class="fas fa-check mr-1"></i> @endif
                                    </td>
                                    <td>
