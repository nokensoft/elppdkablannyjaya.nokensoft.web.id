                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Ubah Profil Wakil Kepala Daerah</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <h1 class="fw-bold">Ubah Profil Wakil Kepala Daerah</h1>
                                ...
                                <form action="{{asset('admin/profil/pemerintah-daerah')}}" method="">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <div class="my-3">
                                            <img src="{{asset('assets/admin/assets/images/users/user-women.png')}}" class="img-thumbnail p-3" alt="Logo" width="350px">
                                        </div>
