                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form action="{{route('admin.dprd.update',$data[0]->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        @else
                                                <img src="{{ url($data[0]->foto)}}" alt="{{$data[0]->slug}}" class="img-fluid img-thumbnail"  width="250px" class="img-thumbnail mb-1"></td>
                                        @endif
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="nama_instansi" value="{{old('nama_instansi') ? old('nama_instansi') : $data[0]->nama_instansi }}">
