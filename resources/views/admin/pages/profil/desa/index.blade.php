                                        ...
                                        @foreach ($datas as $data )
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-between gap-1">
                                                    <a href="{{route('admin.desa.show',$data->id)}}" class="btn btn-sm btn-dark border-0  waves-effect waves-light fs-4"> <i class="fas fa-eye"></i> </a>
                                                    <a href="{{route('admin.desa.edit',$data->id)}}" class="btn btn-sm btn-outline-dark border-0 waves-effect waves-light fs-4"> <i class="fas fa-edit"></i> </a>
                                                    <a href="{{route('admin.desa.delete',$data->id)}}" class="btn btn-sm btn-outline-dark border-0 waves-effect waves-light fs-4"> <i class="fas fa-trash"></i> </a>                                                  
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
