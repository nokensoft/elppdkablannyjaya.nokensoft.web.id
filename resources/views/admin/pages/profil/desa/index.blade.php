                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <a href="{{ route('admin.desa.pdf') }}" target="_blank"
                            ...
                            <table class="table table-bordered fs-4">
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            <td>
                                                @if (empty($data->foto_kepala_desa))
                                    ...
                                    <td class="d-flex justify-content-between gap-1">
                                        <a href="{{ route('admin.desa.show', ['id' => $data->id]) }}"
                                            class="btn btn-sm btn-info border-0  waves-effect waves-light fs-4"> <i
                                                class="fas fa-eye"></i> </a>
                                        <a href="{{ route('admin.desa.edit', $data->id) }}"
                                            class="btn btn-sm btn-outline-info border-0 waves-effect waves-light fs-4"> <i
                                                class="fas fa-edit"></i> </a>
                                        <a href="{{ route('admin.desa.delete', $data->id) }}"
                                            class="btn btn-sm btn-outline-info border-0 waves-effect waves-light fs-4"> <i
