                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form action="{{route('admin.distrik.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" value="{{ old('ibu_kota_distrik')}}"  name="ibu_kota_distrik">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" value="{{ old('longitude')}}"  name="longitude">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" value="{{ old('latitude')}}"  name="latitude">
