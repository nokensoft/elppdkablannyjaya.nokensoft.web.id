                    ...
                    <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                        ...
                        <form action="{{route('admin.distrik.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" value="{{ old('nama_distrik')}}"
                                    name="nama_distrik">
                            ...
                            <div class="mb-3 fs-4">
                                <label for="" class="fw-bold">Ibu Kota</label>
                                <input type="text" class="form-control form-control-lg"
                                    value="{{ old('ibu_kota_distrik')}}" name="ibu_kota_distrik">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    value="{{ old('nama_kepala_distrik')}}" name="nama_kepala_distrik">
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <textarea name="alamat" id="" rows="5"
                                    class="form-control form-control-lg">{{ old('alamat')}}</textarea>
                            ...
                            <div class="mb-3 fs-4">
                                ...
                                <input type="text" class="form-control form-control-lg" value="{{ old('telp')}}"
                                    name="telp">
                                @if($errors->has('telp'))
                            ...
                            <hr class="border my-4">
                            <h4 class="fw-bold text-uppercase mb-3 text-secondary">Google Map</h4>

                            <div class="mb-3 fs-4">
                                <label for="" class="fw-bold">Longitude </label>
                                <input type="text" class="form-control form-control-lg" value="{{ old('longitude')}}"
                                    name="longitude">
                                @if($errors->has('longitude '))
                                <label class="text-danger"> {{ $errors->first('longitude ') }} </label>
                                @endif
                            </div>

                            <div class="mb-3 fs-4">
                                <label for="" class="fw-bold">Latitude </label>
                                <input type="text" class="form-control form-control-lg" value="{{ old('latitude')}}"
                                    name="latitude">
                                @if($errors->has('latitude '))
                                <label class="text-danger"> {{ $errors->first('latitude ') }} </label>
                                @endif
                            </div>
