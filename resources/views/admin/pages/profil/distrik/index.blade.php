                                        ...
                                        @foreach ($all as $data )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('admin.distrik.edit')}}" class="btn btn-sm btn-outline-dark waves-effect waves-light fs-4"> Ubah </a>
                                                    <a href="{{route('admin.distrik')}}" class="btn btn-sm btn-outline-dark waves-effect waves-light fs-4" data-bs-toggle="modal" data-bs-target="#hapusModal"> Hapus </a>
                                                </td>
                                            </tr>
