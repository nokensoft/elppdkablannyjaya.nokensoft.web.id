                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form action="{{route('admin.distrik.update',$data[0]->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')

                                    <div class="mb-3 fs-4">
                                        <label for="" class="fw-bold">Nama Distrik</label>
                                        <input type="text" class="form-control form-control-lg"  name="nama_distrik" value="{{old('nama_distrik') ? old('nama_distrik') : $data[0]->nama_distrik }}">
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="nama_kepala_distrik" value="{{old('nama_kepala_distrik') ? old('nama_kepala_distrik') : $data[0]->nama_kepala_distrik }}">
