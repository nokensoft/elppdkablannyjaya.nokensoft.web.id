                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Detail Distrik</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-6  mx-auto border border-4 border-info rounded shadow-lg p-5 my-5">
                                ...
                                <form >
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        name="nama_distrik" value="{{$data->nama_distrik }}" readonly>
                                    </div>
                                    <div class="mb-3 fs-4">
                                        <label for="" class="fw-bold">Nama ibu kota distrik</label>
                                        <input type="text" class="form-control form-control-lg"  readonly
                                        name="ibu_kota_distrik" value="{{$data->ibu_kota_distrik }}">
                                    </div>

                                    <div class="mb-3 fs-4">
                                        <label for="" class="fw-bold">Nama Kepala Distrik</label>
                                        <input type="text" class="form-control form-control-lg"  readonly value="{{$data->nama_kepala_distrik}}">
                                    </div>
                                    ...
                                    <div class="mb-3 fs-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" readonly value="{{$data->telp }}">
                                    </div>
                                    ...
                                    <div class="border-top border-1 pt-3 mt-4">
                                        <a href="{{ route('admin.distrik.edit',$data->id) }}" class="btn btn-outline-light waves-effect waves-light fs-4">
