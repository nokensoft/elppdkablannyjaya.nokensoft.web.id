                                ...
                                <div class="noti-scroll" data-simplebar>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                        <div class="notify-icon">
                                            <img src="{{ asset('assets/admin/assets/images/users/user-1.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon">
                                            <img src="{{ asset('assets/admin/assets/images/users/user-4.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
