...
<head>
    <meta charset="utf-8" />
    <title>{{ $pengaturan->judul_situs ? $pengaturan->judul_situs : 'Sistem Informasi' }}</title>
                ...
                <div class="container-fluid">
                    <div class="row text-uppercase">
                        <div class="col-md-8">
                            ...
                            </script> &copy; <a href="#" class="link-secondary">Sistem Informasi Laporan Penyelenggaraan
                                Pemerintahan Kabupaten Lanny Jaya</a>
                        </div>
